...
help:
	...
	@echo ""
	@echo "ORACLE_HOST auto-read from terraform output (203.0.113.10 after apply)"
	@echo "Override: make -f deploy.mk deploy ORACLE_HOST=1.2.3.4"

check-host:
ifeq ($(strip $(ORACLE_HOST)),)
	$(error ERROR: ORACLE_HOST empty. Run "make apply" in iac/, or: make -f deploy.mk deploy ORACLE_HOST=203.0.113.10)
endif
