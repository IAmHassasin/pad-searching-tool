...
export const AWAKENING_FILTER_GROUPS: AwakeningFilterGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      [133, 134, 135],
      [43, 61, 107, 111],
      [59, 60, 78, 45, 50, 79, 80, 81, 82, 48, 57, 58],
      [44, 108, 110, 126, 112, 113, 114, 109, 82, 20, 115],
    ],
  },
  {
    label: "Resist",
    rows: [[52, 28, 136, 68, 69, 70, 141, 10, 11, 12, 13, 54, 55, 140, 53, 71, 72]],
  },
  {
    label: "Killer",
  ...
  {
    label: "Enhance orb",
    rows: [[137, 99, 100, 101, 102, 103, 104, 14, 15, 16, 17, 18, 29]],
  },
  {
    label: "Others",
    rows: [[64, 63, 62, 9, 98]],
